...
public class Blur_adapter extends RecyclerView.Adapter<Blur_adapter.Myviewholder> {
    ...
    public Blur_adapter(Context context, int[] option_menu, String[] optionname) {
    ...
    @Override
    public Blur_adapter.Myviewholder onCreateViewHolder(ViewGroup parent, int viewType) {

        View itemView = LayoutInflater.
                from(parent.getContext()).
                inflate(R.layout.item_blur, parent, false);
        Myviewholder viewHolder = new Myviewholder(itemView);
        return viewHolder;
    }

    @Override
    public void onBindViewHolder(Blur_adapter.Myviewholder holder, int position) {


        holder.imFilter.setImageResource(option_menu[position]);


        holder.optionname.setVisibility(View.VISIBLE);
