...
public class Option_adapter extends RecyclerView.Adapter<Option_adapter.Myviewholder> {
    ...
    public Option_adapter(Context context, int[] option_menu, String[] optionname) {
    ...
    @Override
    public Option_adapter.Myviewholder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(Option_adapter.Myviewholder holder, int position) {
